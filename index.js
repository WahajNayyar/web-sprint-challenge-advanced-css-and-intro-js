...
function getArtistByIndex(array, numberIndex) {
  return `the artist at ${numberIndex} is ${array[numberIndex].name}`;
}  
...
function addArtist(array){
  array.push({ 
   ...
   genre: 'Web Design', 
   nationality: 'USA',
   bio: 'lorem ipsum vnbidhfsighrouhfih49hfirjhfijdoih983qyeh'
 })
 return array;  
 }
